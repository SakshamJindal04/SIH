...
footer_html = """<footer>
    <div class="footer-quote" id="footer-quote">Trust is built with consistency.</div>
    <div class="footer-links">
        <a href="about.html">About SafeKart</a>
    </div>
    <p class="footer-copyright">&copy; 2026 SafeKart. All Rights Reserved.</p>
</footer>"""
...
for filename in os.listdir(directory):
    if filename.endswith(".html"):
        ...
        if '<footer>' in content:
            ...
            # Some files might not have footer, append before script or body
            content = content.replace('<script src="theme.js"></script>', footer_html + '\n    <script src="theme.js"></script>')
            content = content.replace('<script src="script.js"></script>', footer_html + '\n    <script src="script.js"></script>')
